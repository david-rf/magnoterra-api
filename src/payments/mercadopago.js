...
class MercadoPagoService {
  ...
  async createPreference(preferenceData) {
    try {
      ...
      return {
        id: prefId,
        init_point: `https://www.mercadopago.com/checkout/v1/redirect?pref_id=${prefId}`,
        sandbox_init_point: `https://sandbox.mercadopago.com/checkout/v1/redirect?pref_id=${prefId}`,
      };
    } catch (error) {
