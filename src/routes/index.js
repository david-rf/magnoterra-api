...
import { createYoutubeUploadBatchMarkdown } from '../services/youtubeSocialMarkdown.js';
...
router.post('/webhooks/youtube-upload-batch', (req, res) => {
  const markdown = createYoutubeUploadBatchMarkdown(req.body);
...
router.get('/', (req, res) => {
  res.json({
    ...
    endpoints: {
      ...
      dbCheck: '/db-check',
      api: '/api',
      youtubeUploadBatch: '/api/webhooks/youtube-upload-batch',
    },
  });
});
