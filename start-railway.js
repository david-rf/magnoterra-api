...
import { renderYoutubeUploadBatchMarkdown } from './src/social/youtubeUploadBatch.js';
...
// Webhook para videos subidos a YouTube
app.post('/api/webhooks/youtube-upload-batch', (req, res) => {
  console.log('YouTube upload batch webhook requested');
